...
bandit13@bandit:~$ ls
sshkey.private
bandit13@bandit:~$ cat /etc/bandit_pass/
cat: /etc/bandit_pass/: Is a directory
bandit13@bandit:~$ cat /etc/bandit_pass/bandit13
...
ssh indica que nos conectaremos a un servidor
-i es para pasar la llave por un archivo
