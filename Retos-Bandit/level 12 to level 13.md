...
bandit12@bandit:~$
bandit12@bandit:~$ mkdir /tmp/saul
bandit12@bandit:~$
bandit12@bandit:~$ cat data.txt | xxd -r > /tmp/saul/datos
bandit12@bandit:~$ cd /tmp/saul/
bandit12@bandit:/tmp/saul$ cat datos
...
4@weRI7}8v9H;uH%}$iKL12v)|Rib AN]BA>Y|.Ebandit12@bandit:/tmp/saul$ file datos
...
bandit12@bandit:/tmp/saul$ mv datos datos.gz
bandit12@bandit:/tmp/saul$ ls
datos.gz
bandit12@bandit:/tmp/saul$ file datos.gz
...
bandit12@bandit:/tmp/saul$ gzip -d datos.gz
bandit12@bandit:/tmp/saul$ ls
datos
bandit12@bandit:/tmp/saul$ file datos
datos: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/saul$ mv datos datos.bz2
bandit12@bandit:/tmp/saul$ ls
datos.bz2
bandit12@bandit:/tmp/saul$ bzip2 -d datos.bz2
bandit12@bandit:/tmp/saul$ ls
datos
bandit12@bandit:/tmp/saul$ file datos
...
bandit12@bandit:/tmp/saul$ mv datos datos.tar
bandit12@bandit:/tmp/saul$ ls
datos.tar
bandit12@bandit:/tmp/saul$ tar xf datos.tar
bandit12@bandit:/tmp/saul$ ls
data5.bin  datos.tar
bandit12@bandit:/tmp/saul$ rm datos.tar
bandit12@bandit:/tmp/saul$ file data5.bin
data5.bin: POSIX tar archive (GNU)
bandit12@bandit:/tmp/saul$ mv data5.bin data5.tar
bandit12@bandit:/tmp/saul$ ls
data5.tar
bandit12@bandit:/tmp/saul$ tar xf data5.tar
bandit12@bandit:/tmp/saul$ ls
data5.tar  data6.bin
bandit12@bandit:/tmp/saul$ rm data5.tar
bandit12@bandit:/tmp/saul$ file data6.bin
data6.bin: bzip2 compressed data, block size = 900k
bandit12@bandit:/tmp/saul$ mv data6.bin  data6.bz2
bandit12@bandit:/tmp/saul$ ls
data6.bz2
bandit12@bandit:/tmp/saul$ bzip2 -d data6.bz2
bandit12@bandit:/tmp/saul$ ls
data6
bandit12@bandit:/tmp/saul$ file data6
data6: POSIX tar archive (GNU)
bandit12@bandit:/tmp/saul$ mv data6 data6.tar
bandit12@bandit:/tmp/saul$ ls
data6.tar
bandit12@bandit:/tmp/saul$ tar xf data6.tar
bandit12@bandit:/tmp/saul$ ls
data6.tar  data8.bin
bandit12@bandit:/tmp/saul$ rm data6.tar
bandit12@bandit:/tmp/saul$ file data8.bin
data8.bin: gzip compressed data, was "data9.bin", last modified: Sun Apr 23 18:04:23 2023, max compression, from Unix, original size modulo 2^32 49
bandit12@bandit:/tmp/saul$ mv data8.bin data8.gz
bandit12@bandit:/tmp/saul$ ls
data8.gz
bandit12@bandit:/tmp/saul$ file data8.gz
data8.gz: gzip compressed data, was "data9.bin", last modified: Sun Apr 23 18:04:23 2023, max compression, from Unix, original size modulo 2^32 49
bandit12@bandit:/tmp/saul$ gzip -d data8.gz
bandit12@bandit:/tmp/saul$ ls
data8
bandit12@bandit:/tmp/saul$ file data8
data8: ASCII text
bandit12@bandit:/tmp/saul$ cat data8
The password is wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw
bandit12@bandit:/tmp/saul$
```
otra solucion en pantalla
```
bandit12@bandit:~$ xxd -r data.txt | zcat | bzcat | zcat | tar xO | tar xO | bzcat | tar xO | zcat
The password is wbWdlBxEir4CaE8LaPhauuOo6pwRmrDw
```
### Notas adicionales:
comando file nos dice el tipo de archivo que es
comando touch crea archivos
xxd -r revierte el vaciado exadecimal
vaciado exadecimal es una vista para ver los codigos de cada caracter
mv renombra un archivo
### Referencias:
https://learning.lpi.org/es/learning-materials/010-160/3/3.1/3.1_01/#:~:text=Existen%20muchas%20herramientas%20de%20compresi%C3%B3n,o%20bzip%20no%20est%C3%A1n%20instalados.