...
- Vemos que el archivo es un código java que revisa si la contraseña es correcta.
- leemos el codigo y obtenemos la bandera de la validación de la contraseña.
``` bash
┌──(kali㉿kali)-[~/Retos]
