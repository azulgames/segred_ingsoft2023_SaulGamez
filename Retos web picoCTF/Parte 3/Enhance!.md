...
``` bash
saulgamez-picoctf@webshell:~$ cat drawing.flag.svg 
...
descargamos el archivo y lo revisamos con cat.
parece que las ultimas 2 etiquetas de id contienen partes de la bandera
